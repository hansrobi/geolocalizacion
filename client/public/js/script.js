document.addEventListener("DOMContentLoaded", () => {
    ...
    registerForm.addEventListener("submit", async (event) => {
        ...
        try {
            const response = await fetch(
                "https://geolocalizacion-two.vercel.app/api/registro",
                {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
    ...
    grupoSelect.addEventListener("change", async () => {
        ...
        try {
            const response = await fetch(
                `https://geolocalizacion-two.vercel.app/api/ubicaciones?grupo=${grupo}`,
                {
                    method: "GET",
                    headers: {
    ...
    document.getElementById("update-btn").addEventListener("click", () => {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(async (position) => {
                ...
                try {
                    const response = await fetch(
                        "https://geolocalizacion-two.vercel.app/api/actualizar-ubicacion",
                        {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
    ...
    addUserForm.addEventListener("submit", async (event) => {
        ...
        try {
            const response = await fetch(
                "https://geolocalizacion-two.vercel.app/api/agregar-grupo",
                {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
    ...
    function leerUbicacionUsuario() {
        const token = localStorage.getItem("token");
        return fetch(
            "https://geolocalizacion-two.vercel.app/api/leer-ubicacion",
            {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
